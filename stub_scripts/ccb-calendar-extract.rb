...
ccb_url = "<url>"
##############################
ccb_service = "public_calendar_listing"
...
puts("==================================================================================================")
puts("CCB Calendar Extraction Script - intended to export public calendar detail info from CCB")
puts("==================================================================================================")
puts("")
puts("Extraction Mode:")
puts "******************************************************"
      puts "Beginning to extracting calendar... (This may take several minutes)"
